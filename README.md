...
1. Learn the fundamentals of programming
   ...
   * [Open Source Society's Intro to Programming and Intro to Computer Science](https://github.com/ossu/computer-science#intro-cs) I think this is a good program and what I would recommend to people with no programming experience. It is free, has a beginner-friendly structure, is taught in Python, and has a good roadmap for future topics. Make sure you do the exercises, problem sets, etc. It's easy to think you can learn from just watching the videos.. you can't. You learn by doing things repeatedly
